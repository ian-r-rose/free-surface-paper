...
the ``drunken sailor'' instability, which severely limit timestep sizes. Several 
...
We estimate the error by time-integrating the L2 difference between the numerical and analytical

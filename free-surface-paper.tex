...
We summarize this section by describing pseudocode for the implementation.
There are two variations, one using the quasi-implicit scheme and one using nonstandard finite differences.

For the quasi-implicit scheme:
\begin{enumerate}
...
For the nonstandard finite difference scheme:
\begin{enumerate}

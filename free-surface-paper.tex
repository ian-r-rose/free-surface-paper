...
In many simulations we expect that the geometry, density and viscosity structure of the model will not change so significantly
that the $\tau^*$ would need to be updated frequently (if ever).

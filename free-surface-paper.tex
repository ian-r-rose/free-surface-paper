...
In many cases this is accomplished through a Lagrangian or arbitrary Lagrangian-Eulerian (ALE) scheme (see Section~\ref{sec:implementation}).
...
Figure~\ref{fig:pseudocode} shows pseudocode descriptions of the two free surface algorithms described in this section.
...
% \end{subfigure}
% \caption{Pseudocode descriptions of the free surface implementations.}
